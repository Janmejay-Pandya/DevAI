...
const NewProjectCard = () => {
  ...
  return (
    <div className="relative flex flex-col justify-center items-center h-[calc(100vh-58px)] bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-6 overflow-hidden">
      <div className="max-w-lg w-full bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            className={`w-full flex items-center justify-center gap-2 py-3 px-6 rounded-xl font-medium transition-all duration-200 shadow-lg ${
              idea.trim() && !isLoading
            ...
            {["A fitness tracking app", "An e-commerce store", "A note taking app"].map(
              (suggestion) => (
                <button
                  ...
                  className="text-sm px-4 py-2 bg-gradient-to-r from-indigo-50 to-purple-50 hover:from-indigo-100 hover:to-purple-100 rounded-full text-gray-700 transition-all duration-200 border border-indigo-100 hover:border-indigo-200 hover:shadow-md"
                >
                  {suggestion}
                </button>
              ),
      ...
      <div className="absolute top-20 left-10 w-2 h-2 bg-indigo-400 rounded-full animate-ping opacity-50"></div>
      <div className="absolute bottom-32 right-20 w-3 h-3 bg-purple-400 rounded-full animate-pulse opacity-50"></div>
      <div
        className="absolute top-1/3 right-10 w-2 h-2 bg-pink-400 rounded-full animate-ping opacity-50"
